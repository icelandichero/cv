startImageTransition();
    ...
    function startImageTransition() {
        ...
        var images = document.getElementsByClassName("image-style-1");
        ...
        //Active
        //window.addEventListener('focus', setInterval(changeImage, 6000));
        ...
        /* This function chnages the opacity of
